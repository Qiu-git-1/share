...
def parse_dataset_files(object_name, dataset_base_dir, anomaly_maps_dir):
    ...
    Args:
        object_name: Name of the dataset object.数据集对象的名称
        dataset_base_dir: Base directory of the MVTec AD dataset.MVTec AD数据集的基本目录
        anomaly_maps_dir: Base directory where anomaly maps are located.异常地图所在的基本目录
    """
